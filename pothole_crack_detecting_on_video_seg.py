...
while True:
    ...
    if out is None:
        ...
        out = cv2.VideoWriter(r'D:\pothole_detectiong\pothole_crack_segmented_no_bbox.mp4', fourcc, fps, (width, height))
        if not out.isOpened():
        ...
        for i, mask in enumerate(mask_data):
            ...
            if i < len(pothole_boxes):
                ...
                if len(xs) > 0 and len(ys) > 0:
                    ...
                    cv2.putText(frame, label, (center_x, center_y), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)
...
print("Video processing with pothole and crack segmentation completed successfully.")
